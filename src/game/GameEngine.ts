...
export class GameEngine {
  ...
  public cleanup() {
    if (!this.isMobile) {
      ...
      this.canvas.removeEventListener('mousedown', () => this.input.shoot = true);
      this.canvas.removeEventListener('mouseup', () => this.input.shoot = false);
    }
  }
  ...
  public handleTouchAim(angle: number) {
    if (this.playerTank) {
      this.playerTank.rotateTurret(angle);
    }
  }
}